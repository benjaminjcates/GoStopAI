...
class Game:
    ...
    def calc_point_total(self, player_num):
        player_num.point_total = 0
    ...
    def play_game(self, first_to_act):
        ...
        while still_playing:
            ...
            lay_down = self.current_player.lay_down_card(self.current_player.cards_in_hand)
